...
class AIHttpClient:
    ...
    used for multiple/single requests, and then can be discarded, relying on
    ...
    async def get(
        ...
        return await self._request(
            HTTPMethods.GET, path, headers=headers, cookies=cookies,
    ...
    async def post(
        ...
        return await self._request(
            HTTPMethods.POST, path, headers=headers, cookies=cookies, json_data=json_data,
    ...
    async def put(
        ...
        return await self._request(
            HTTPMethods.PUT, path, headers=headers, cookies=cookies, json_data=json_data,
            data=data, params=params, allow_redirects=allow_redirects,
        )
    ...
    async def delete(
        ...
        return await self._request(
            HTTPMethods.DELETE, path, headers=headers, cookies=cookies, json_data=json_data,
            data=data, params=params, allow_redirects=allow_redirects,
        )
    ...
    async def patch(
        ...
        return await self._request(
            HTTPMethods.PATCH, path, headers=headers, cookies=cookies,
